...
dinValue = np.array([('AA', -0.16), ('AT', -0.57), ('AG', 0.34), ('AC', -0.43), ('TA', 0.38), ('TT', -0.16),('TG', 1.88), ('TC', -0.01), ('GA', -0.01), ('GT', -0.43), ('GG', 0.28),('GC', 0.31), ('CA', 1.88), ('CT', 0.34),('CG', 0.68), ('CC', 0.28)], dtype=object)
...
with open ('/home/amin/1_HEMA/1_MySQL/1_ensembl_core_database/1_arabidopsis_thaliana/2_attached_table/3_table_seq_region_position_attrib_value/3_physicochemical properties/2_at_slide65_SW_101bp_10006.csv', 'a') as csvfile:
	...
	for seq in SeqIO.parse(fasta_file,"fasta"):
		...
		for i in range(len(seq.seq)):
			if seq.seq[i] != 'N':
				n=n+1
				writer.writerow([n,10006,array[1][c]])
				c=c+1
			else:
				n=n+1
				writer.writerow([n,10006,'Null'])
