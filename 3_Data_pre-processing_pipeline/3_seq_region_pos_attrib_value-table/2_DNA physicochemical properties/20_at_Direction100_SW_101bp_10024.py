...
#Direction100_10023-10024
dinValue = np.array([('AA',-154), ('AC',143), ('AG',2), ('AT',0),
		    ('CA',-64), ('CC',-57),('CG',0), ('CT',-2), 
		    ('GA',120), ('GC',180), ('GG',57),('GT',-143), 
		    ('TA',0), ('TC',-120),('TG',64), ('TT',154)], dtype=object)
...
with open ('/home/amin/1_HEMA/1_MySQL/1_ensembl_core_database/1_arabidopsis_thaliana/2_attached_table/3_table_seq_region_position_attrib_value/3_physicochemical properties/20_at_Direction100_SW_101bp_10024.csv', 'a') as csvfile:
	...
	for seq in SeqIO.parse(fasta_file,"fasta"):
		...
		for i in range(len(seq.seq)):
			if seq.seq[i] != 'N':
				n=n+1
				writer.writerow([n,10024,array[1][c]])
				c=c+1
			else:
				n=n+1
				writer.writerow([n,10024,'Null'])
